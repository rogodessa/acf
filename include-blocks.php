...
define('LTU_THEME_DIRECTORY', get_stylesheet_directory() );
define('LTU_THEME_URL', get_stylesheet_directory_uri() );
...
function register_acf_blocks() {
    $blocks_directory = LTU_THEME_DIRECTORY . '/templates/blocks/';
